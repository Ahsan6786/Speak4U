...
import { ArrowLeft, History, Calendar, Trash2, ArrowRight, LayoutGrid, Flame, Brain, TrendingUp, Sparkles, Gauge, Target } from "lucide-react";
...
export default function ReportsPage() {
  ...
  const [filter, setFilter] = useState<"all" | "confidence" | "levels" | "fluency">("all");
  ...
  return (
    <main className="min-h-screen bg-background text-foreground p-6 md:p-12 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        {/* Quick Stats Grid (Exposing the 'Confidence' and 'Levels' requested) */}
